  ...
  return (
    <div className="min-h-screen bg-white text-gray-800">
      ...
      <div className="container mx-auto px-4 py-16 grid grid-cols-1 md:grid-cols-2 gap-12">
        <div>
          <h2 className="text-2xl font-semibold mb-4 text-[#ff8228]">Sứ mệnh</h2>
        ...
        <div>
          <h2 className="text-2xl font-semibold mb-4 text-[#ff8228]">Tầm nhìn</h2>
          <p className="text-gray-700 text-sm md:text-base">
      ...
      <div className="bg-gray-50 py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-semibold mb-8 text-center text-[#ff8228]">Giá trị cốt lõi</h2>
